...
`initialState` - the second parameter. You may initialize state from this function, and whatever's returned from this function is returned as the state object.
